...
st.caption("Football Edge Pro · Multiliga v12 · Jornada Scanner + Cards V3 + actualización incremental")
st.caption(
...
tab_scanner, tab_matches, tab_best, tab_1x2 = st.tabs(
    [
        "🔎 Scanner jornada",
        "📊 Partido a partido",
        "⭐ Picks manuales",
...
with tab_scanner:
    st.markdown(
        "### 🔎 Scanner completo de la jornada"
    )

    st.caption(
        "Analiza de una vez todos los mercados validados del motor. "
        "El modelo te da probabilidad, cuota justa y cuota mínima para "
        f"EV ≥ {min_ev_percent}%. Tú solo introduces las cuotas que veas "
        "en tu casa de apuestas."
    )
        ...
        if filtered.empty:
            ...
            edited = st.data_editor(
                ...
                column_config={
                    ...
                    "Tipo mercado": st.column_config.TextColumn(
                        "Tipo",
                        width="small",
                    ),
                    ...
                    "Cuota": st.column_config.NumberColumn(
                        ...
                        width="small",
                        help=(
                            "Introduce la cuota decimal real "
                            "que te ofrece tu casa."
                        ),
                    ),
            ...
            for row in edited.itertuples(
                ...
                # itertuples renombra columnas con espacios; leemos
                # por posición de forma segura desde el dataframe.
            ...
            if quoted.empty:
                st.info(
                    "Introduce una o varias cuotas en la tabla. "
                    "En cuanto lo hagas, aquí aparecerá el ranking "
                    "por valor esperado."
                )
                ...
                st.caption(
                    "Mientras no hay cuotas, esto es solo un ranking "
                    "predictivo; NO significa que sean apuestas con valor."
                )
                ...
                st.caption(
                    ...
                    "No implica beneficio garantizado ni sustituye "
                    "la validación histórica contra cuotas."
                )
