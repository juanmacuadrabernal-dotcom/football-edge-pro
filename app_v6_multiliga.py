...
st.caption("Football Edge Pro · Multiliga v6 · fixtures automáticos")
st.caption(
...
if not predictions:
    if league_key == "laliga":
        st.warning(
            "Los modelos están creados, pero LaLiga no tiene "
            "fixtures futuros cargados todavía."
        )
        st.code(
        ...
        st.caption(
            "Después pulsa «Recargar jornada» en el menú lateral."
        )
    else:
        st.warning(
