...
try:
    from prediction_engine_laliga_v2 import PredictionEngineLaLiga
except Exception:
...
def run_laliga_updater():
    updater = BASE_DIR / "update_laliga_fixtures_v2.py"
...
st.caption("Football Edge Pro · Multiliga v7 · actualización desde la app")
st.caption(
...
if not predictions:
    if league_key == "laliga":
        st.warning(
            "Los modelos están listos. Solo faltan cargar "
            "los próximos partidos de LaLiga."
        )
