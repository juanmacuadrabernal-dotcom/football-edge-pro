...
st.set_page_config(
    page_title="Football Edge Pro v15.2",
    page_icon="⚽",
    layout="wide",
...
def sidebar():
    with st.sidebar:
        ...
        st.markdown("<br><div style='font-size:10px;color:#74899e'>Football Edge Pro v15.2<br>Analistas, no apostadores.</div>",unsafe_allow_html=True)
