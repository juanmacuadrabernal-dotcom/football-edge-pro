...
from football_odds_hybrid_v15_1_5 import populate_match_odds, get_api_key, DEFAULT_BOOKMAKERS
...
def market_page(match,league,cat,min_ev):
    ...
    if cat=="sot":
        if auto_status.get("sot_ok"):
            st.success("🎯 SOT automático conectado · SportsGameOdds · Bet365 / Pinnacle")
