...
def train_final(long_df, numeric, categorical):
    ...
    joblib.dump(
        model,
        MODELS_DIR / "corners_v1_poisson.joblib",
    )
...
def main():
    print()
    print("=" * 76)
    print("ELITESERIEN EDGE PRO - CORNERS MODEL V1")
    print("=" * 76)
    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        pred.to_csv(
            REPORTS_DIR / "corners_v1_backtest_predictions.csv",
            index=False,
            encoding="utf-8-sig",
        )

        summary.to_csv(
            REPORTS_DIR / "corners_v1_backtest_summary.csv",
            index=False,
            encoding="utf-8-sig",
        )
