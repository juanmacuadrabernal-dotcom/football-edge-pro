...
class PredictionEngineLaLiga:
    ...
    def predict_goals(self, fixture):
        ...
        base_o35 = poisson_over(
            3.5,
            baseline_total,
        )

        weight_o25 = self._latest_shrink_weight(
            "goals_v4_backtest_predictions",
            "over_2_5",
            0.95,
        )

        # Over 3.5 tuvo señal, pero fue menos estable que Over 2.5.
        # Por eso se mantiene como mercado secundario.
        weight_o35 = self._latest_shrink_weight(
            "goals_v4_backtest_predictions",
            "over_3_5",
            0.75,
        )
        ...
        final_o25 = (
            weight_o25 * raw_o25
            + (1 - weight_o25) * base_o25
        )

        final_o35 = (
            weight_o35 * raw_o35
            + (1 - weight_o35) * base_o35
        )
        ...
        return {
            ...
            "over_3_5": float(np.clip(final_o35, 0, 1)),
            "home_win_raw": ph,
            "draw_raw": pd_,
            "away_win_raw": pa,
        }
