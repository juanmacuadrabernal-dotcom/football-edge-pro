...
def main():
    print()
    print("=" * 80)
    print("LALIGA EDGE PRO - ACTUALIZAR PROXIMA JORNADA")
    print("=" * 80)
    ...
    with sqlite3.connect(
        ...
        # Quitamos solo fixtures no terminados de la temporada actual
        # para evitar duplicados de fuentes/IDs antiguos.
