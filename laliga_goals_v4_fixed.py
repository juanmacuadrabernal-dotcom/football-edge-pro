...
def main():
    print()
    print("=" * 76)
    print("LALIGA EDGE PRO - GOALS V4 CHAMPION")
    print("=" * 76)
    ...
    with sqlite3.connect(DB_PATH) as conn:
        ...
        pred.to_csv(
            REPORTS_DIR / "laliga_goals_v4_backtest_predictions.csv",
            index=False,
            encoding="utf-8-sig",
        )

        summary.to_csv(
            REPORTS_DIR / "laliga_goals_v4_backtest_summary.csv",
            index=False,
            encoding="utf-8-sig",
        )
