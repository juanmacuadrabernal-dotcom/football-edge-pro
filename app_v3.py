...
from prediction_engine_v3 import PredictionEngine
...
st.success("✅ v2.1 · OVER 3.5 GOLES ACTIVO")
st.caption(
...
if "over_3_5" not in first.get("goals", {}):
    st.error(
        "Esta versión del motor no está devolviendo Over 3.5. "
        "Asegúrate de ejecutar app_v3.py junto a prediction_engine_v3.py."
    )
    st.stop()
