...
def render_hero_header(league_label, league_title, league_key):
    ...
    html = f"""
    <div class="hero-card">
        <div class="hero-topline">Football Edge Pro · Multiliga v13</div>
        <h1 class="hero-title">⚽ {league_title}</h1>
        <div class="hero-subtitle">{league_label} · diseño renovado, más limpio, más premium y más cómodo para escanear oportunidades.</div>
        <div class="chip-row">
